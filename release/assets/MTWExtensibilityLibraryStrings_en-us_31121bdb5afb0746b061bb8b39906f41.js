define([], function() {
  return {
    ...
    "WebComponents" : {
      "Header": {
        "Description": "Replaces the out of the box page header with a custom header for CLE.",
        "DisplayName": "Page Header"
      },
      "Stream" : {
        "Description" : "Displays a stream video for the user to play.",
        "DisplayName": "Stream Video"
      },
      "Register" : {
        ...
        "Codes" : {
          "UNREGISTERED": "Successfully unregistered for session.",
          "FAILEDUNREGISTERED": "Could not unregister for the session. Please contact the system administrator.",
          "SESSIONNOTFOUND": "Session not found. Please retry or contact the system administrator.",
          "REGISTRATIONFAILED": "Failed to register for the session. Please contact the system administrator",
          "REGISTERED": "Successfully registered for session.",
          "ERRORREGISTERING": "Error registering for the session"
        }
      },
      "Star" : {
        "Description" : "Branded circular star",
        "DisplayName" : "Star"
      },      
      "SidePanel": {
